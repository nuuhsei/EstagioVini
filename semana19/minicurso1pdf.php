<?php
	...
	$sqly = " SELECT * FROM registro WHERE minicurso1='1'and pagamento='1' ";
	...
	// Carrega seu HTML
	$dompdf->load_html('
			<h1 style="text-align: center;">Relatório MiniCurso 1 </h1>
			<h1 style="text-align: center;"> Conhecendo a Física Médica </h1>
			'. $html .'
		');
