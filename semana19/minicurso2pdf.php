<?php
	...
	$sqly = " SELECT * FROM registro WHERE minicurso2='1'and pagamento='1' ";
	...
	// Carrega seu HTML
	$dompdf->load_html('
			<h1 style="text-align: center;">Relatório MiniCurso 2 </h1>
			<h1 style="text-align: center;"> Fundamentos e Aplicações das Microscopias Eletrônicas e de Força Atômica </h1>
			'. $html .'
		');
