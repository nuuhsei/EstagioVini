        ...
        <div class="col-lg-12 col-md-10">
          <div class="card bg-secondary shadow border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              if ($idt){
                ...
                if($minicurso1 == '1'){
                  if($totalminicurso1 >= $limit){
                    $sqlyvalida1 = "UPDATE registro SET minicurso1='" . $minival . "' WHERE id='" . $idt . "' ";
                    $atualizarmini1 = mysqli_query($con, $sqlyvalida1);
                    if($atualizarmini1){
                    ...
                    echo '<div class="alert alert-success">
                          <strong><i class="em em-checkered_flag"></i> Sucesso!</strong> Minicurso 1 CONFIRMADO. <i class="em em-moneybag"></i>
                        </div>';
                  }
                }
                ...
                if($minicurso2 == '1'){
                  if($totalminicurso2 >= $limit){
                    $sqlyvalida2 = "UPDATE registro SET minicurso2='" . $minival . "' WHERE id='" . $idt . "' ";
                    $atualizarmini2 = mysqli_query($con, $sqlyvalida2);
                    if($atualizarmini2){
                    ...
                    echo '<div class="alert alert-success">
                          <strong><i class="em em-checkered_flag"></i> Sucesso!</strong> Minicurso 2 CONFIRMADO. <i class="em em-moneybag"></i>
                        </div>';
                  }
                }
                ...
                if($minicurso3 == '1'){
                  if($totalminicurso3 >= $limit){
                    $sqlyvalida3 = "UPDATE registro SET minicurso3='" . $minival . "' WHERE id='" . $idt . "' ";
                    $atualizarmini3 = mysqli_query($con, $sqlyvalida3);
                    if($atualizarmini3){
                    ...
                    echo '<div class="alert alert-success">
                          <strong><i class="em em-checkered_flag"></i> Sucesso!</strong>  Minicurso 3 CONFIRMADO. <i class="em em-moneybag"></i>
                        </div>';
                  }
                }
                ...
                if($minicurso4 == '1'){
                  if($totalminicurso4 >= $limit){
                    $sqlyvalida4 = "UPDATE registro SET minicurso4='" . $minival . "' WHERE id='" . $idt . "' ";
                    $atualizarmini4 = mysqli_query($con, $sqlyvalida4);
                    if($atualizarmini4){
                    ...
                    echo '<div class="alert alert-success">
                          <strong><i class="em em-checkered_flag"></i> Sucesso!</strong> Minicurso 4 CONFIRMADO. <i class="em em-moneybag"></i>
                        </div>';
                  }
                }
                ...
                if($minicurso5 == '1'){
                  if($totalminicurso5 >= $limit){
                    $sqlyvalida5 = "UPDATE registro SET minicurso5='" . $minival . "' WHERE id='" . $idt . "' ";
                    $atualizarmini5 = mysqli_query($con, $sqlyvalida5);
                    if($atualizarmini5){
                    ...
                    echo '<div class="alert alert-success">
                          <strong><i class="em em-checkered_flag"></i> Sucesso!</strong>  Minicurso 5 CONFIRMADO. <i class="em em-moneybag"></i>
                        </div>';
                  }
                }
                ...
                if($minicurso6 == '1'){
                  if($totalminicurso6 >= $limit){
                    $sqlyvalida6 = "UPDATE registro SET minicurso6='" . $minival . "' WHERE id='" . $idt . "' ";
                    $atualizarmini6 = mysqli_query($con, $sqlyvalida6);
                    if($atualizarmini6){
                    ...
                    echo '<div class="alert alert-success">
                          <strong><i class="em em-checkered_flag"></i> Sucesso!</strong>  Minicurso 6 CONFIRMADO. <i class="em em-moneybag"></i>
                        </div>';
                  }
                }

                if($conf1 == 0 && $conf2 == 0 && $conf3 == 0 && $conf4 == 0 && $conf5 == 0 && $conf6 == 0 ){
              ...
              <br><br><form action="http://df.fc.unesp.br/semana/semana19/controle.php" method="POST">
              <input type="text" name="pesquisa" placeholder="Pesquisa por nome " />
              <button class="button">Deve ser idêntico a inscrição (Pesquisar)
              </button>
              </form>
              <br><br>
                <a href="controlepalestra.php">Relação cadastrados apenas em PALESTRAS</a><br>
                <a href="controleverificaescolha.php">Escolha dos Minicursos Relação </a>
              <br><br>
                  ...
                  <td>
                    ...
                    <?php
                      if($dado["pagamento"] == 0){
                        ...
                        <form action="http://df.fc.unesp.br/semana/semana19/controle.php" method="POST">
                        <input type="hidden" name="id" value="<?php echo $dado['id'];?>" />
                        <input type="hidden" name="minicurso1" value="<?php echo $dado['minicurso1'];?>" />
                        <input type="hidden" name="minicurso2" value="<?php echo $dado['minicurso2'];?>" />
                        <input type="hidden" name="minicurso3" value="<?php echo $dado['minicurso3'];?>" />
                        <input type="hidden" name="minicurso4" value="<?php echo $dado['minicurso4'];?>" />
                        <input type="hidden" name="minicurso5" value="<?php echo $dado['minicurso5'];?>" />
                        <input type="hidden" name="minicurso6" value="<?php echo $dado['minicurso6'];?>" />
                        <button class="button">Validar
                        </button>
                        </form>
                        <?php
                      }
