<?php
	...
	$sqly = " SELECT * FROM registro WHERE minicurso3='1'and pagamento='1' ";
	...
	// Carrega seu HTML
	$dompdf->load_html('
			<h1 style="text-align: center;">Relatório MiniCurso 3 </h1>
			<h1 style="text-align: center;"> Criando sua História em Quadrinhos (HQ) sobre conceitos da Física </h1>
			'. $html .'
		');
