<?php
	...
	$sqly = " SELECT * FROM registro WHERE minicurso'.$minicurso.'='1'and pagamento='1' ";
	...
	// Carrega seu HTML
	$dompdf->load_html('
			<h1 style="text-align: center;">Relatório MiniCurso '.$minicurso.' </h1>
			'. $html .'
		');
