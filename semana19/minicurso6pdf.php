<?php
	...
	$sqly = " SELECT * FROM registro WHERE minicurso6='1'and pagamento='1' ";
	...
	// Carrega seu HTML
	$dompdf->load_html('
			<h1 style="text-align: center;">Relatório MiniCurso 6 </h1>
			<h1 style="text-align: center;"> Introdução á Relatividade ( Exclusivo público feminino )   </h1>
			'. $html .'
		');
