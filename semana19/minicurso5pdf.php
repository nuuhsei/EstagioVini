<?php
	...
	$sqly = " SELECT * FROM registro WHERE minicurso5='1'and pagamento='1' ";
	...
	// Carrega seu HTML
	$dompdf->load_html('
			<h1 style="text-align: center;">Relatório MiniCurso 5 </h1>
			<h1 style="text-align: center;"> Wolfram Mathematica comandos, programação e exemplos  </h1>
			'. $html .'
		');
